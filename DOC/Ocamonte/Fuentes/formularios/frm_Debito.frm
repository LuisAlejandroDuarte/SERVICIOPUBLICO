...
Dim Reg As ADODB.Recordset
 ...
 End If
    ...
    If gError = 0 Then
       If Not Reg.BOF Then
          SQL = "DELETE FROM debito WHERE id_suscriptor=" & Reg("id") & " " _
          & " AND id_fecha=" & gFecha
          BaseExecute SQL
       
       
          SQL = "INSERT INTO Debito (id_suscriptor,id_fecha,valor) " _
          & " VALUES (" & Reg("id") & ", " _
