...
Begin VB.Form frm_Abonos 
   Caption         =   "Listado de Abonos"
   ClientHeight    =   7395
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   10635
   ...
   Begin VB.Frame FraTabla 
      ...
      Begin VB.Frame fraCodigo 
         ...
         Begin VB.ComboBox cmbFecha 
            Height          =   315
            ItemData        =   "frm_Abonos.frx":0000
            Left            =   150
            List            =   "frm_Abonos.frx":0002
      ...
      Begin MSComctlLib.ImageList imgList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Abonos.frx":0004
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Abonos.frx":5C26
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Abonos.frx":D128
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Abonos.frx":1291A
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Abonos.frx":15654
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Abonos.frx":1B8EE
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Dim SQL As String
    ...
    If MsgBox("Desea Eliminar el Abono Seleccionado ? " & mfgAbonos.TextMatrix(mfgAbonos.Row, 1), vbDefaultButton2 + vbYesNo) = vbYes Then
       SQL = "DELETE FROM abono WHERE id_factura=" & id & " " _
       & " AND id_fecha=" & idd
       BaseExecute SQL
       FiltroAvanzado
    End If
...
Dim iForm As frm_Abono
Dim Report As frm_Reporte
    Select Case Button.key
        
        Case "btnNuevo"
             Set iForm = New frm_Abono
             iForm.Show 1, Me
             FiltroAvanzado
             
        Case "btnImprimir"
            Set Report = New frm_Reporte
            Report.UpdateReport SQLFilter, "", "RptAbonos2.rpt", False, "LISTADO ABONOS", False
            Report.Show
...
Dim lsql As String
 ...
 & " abono.valor AS Valor,abono.id_factura,abono.id_fecha " _
 & " FROM suscriptor,abono,fecha,detalle_facturacion WHERE " _
 & " suscriptor.id=detalle_facturacion.id_suscriptor AND " _
 & " abono.id_factura=detalle_facturacion.id_factura AND abono.id_fecha=fecha.id " _
 & " AND fecha.id=" & iFecha
