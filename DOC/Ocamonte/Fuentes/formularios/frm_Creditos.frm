   ...
   Begin VB.Frame FraTabla 
      ...
      Begin VB.Frame fraCodigo 
         ...
         Begin VB.ComboBox cmbFecha 
            Height          =   315
            ItemData        =   "frm_Creditos.frx":0000
            Left            =   150
            List            =   "frm_Creditos.frx":0002
      ...
      Begin MSComctlLib.ImageList imgList 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Creditos.frx":0004
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Creditos.frx":5C26
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Creditos.frx":D128
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Creditos.frx":1291A
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Creditos.frx":15654
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "frm_Creditos.frx":1B8EE
               Key             =   ""
            EndProperty
         EndProperty
      End
...
Dim SQL As String
    ...
    If MsgBox("Desea Eliminar el Crédito Seleccionado ? " & mfgAbonos.TextMatrix(mfgAbonos.Row, 1), vbDefaultButton2 + vbYesNo) = vbYes Then
       SQL = "DELETE FROM credito WHERE id_suscriptor=" & id & " " _
       & " AND id_fecha=" & idd
       BaseExecute SQL
       FiltroAvanzado
    End If
...
Dim iForm As frm_Credito
Dim Report As frm_Reporte
    Select Case Button.key
        
        Case "btnNuevo"
             Set iForm = New frm_Credito
             iForm.Show 1, Me
             FiltroAvanzado
             
        Case "btnImprimir"
            Set Report = New frm_Reporte
            Report.UpdateReport SQLFilter, "", "Rptcredito.rpt", False, "", False
            Report.Show
...
Dim lsql As String
 ...
 & " credito.valor AS Valor,suscriptor.id,fecha.id " _
 & " FROM suscriptor,credito,fecha WHERE " _
 & " suscriptor.id=credito.id_suscriptor AND " _
 & " credito.id_fecha=fecha.id " _
 & " AND fecha.id=" & iFecha
