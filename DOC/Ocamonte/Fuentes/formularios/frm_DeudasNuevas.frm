...
Begin VB.Form frm_DeudasNuevas 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Mantenimiento de Deudas"
   ClientHeight    =   2475
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   7845
   ...
   Begin VB.Frame FraControles 
      ...
      Begin VB.CommandButton CmdUltimo 
         Height          =   300
         Left            =   2430
         Picture         =   "frm_DeudasNuevas.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   165
         Width           =   300
      ...
      Begin VB.CommandButton CmdSiguiente 
         Height          =   300
         Left            =   2010
         Picture         =   "frm_DeudasNuevas.frx":02D6
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   165
         Width           =   300
      ...
      Begin VB.CommandButton CmdAnterior 
         Height          =   300
         Left            =   510
         Picture         =   "frm_DeudasNuevas.frx":0611
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   165
         Width           =   300
      ...
      Begin VB.CommandButton CmdPrimero 
         Height          =   300
         Left            =   120
         Picture         =   "frm_DeudasNuevas.frx":094A
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   165
         Width           =   300
   ...
   End
End
Attribute VB_Name = "frm_DeudasNuevas"
...
'    End If
    ...
    SQL = "SELECT * FROM deuda WHERE nombre='" & Trim(txtNombre.Text) & "'"
    Set Reg = New ADODB.Recordset
    ExecuteSql Reg, SQL
    If gError = 0 Then
       If Editar = False Then
...
Dim dc As Integer
    ...
    If Editar Then
       SQL = "UPDATE deuda SET nombre='" & Trim(txtNombre.Text) & "' " _
       ...
       End If
     Else
       SQL = "INSERT INTO deuda (nombre) " _
...
Dim lsql As String
    ...
    If Criterio <> "" Then
       lsql = "SELECT count(*) FROM  deuda " _
             & " WHERE  "
...
Dim ElemBusq As Integer
  ...
  frmBuscar.Caption = "Búsqueda de deudaes"
  frmBuscar.Show 0, Me
...
Dim Mensaje
   If CmdEliminar.Caption = "&Eliminar" Then
       Mensaje = MsgBox("Desea Eliminar el deuda : " + txtNombre.Text, vbDefaultButton2 + vbExclamation + vbYesNo)
       If Mensaje = vbYes Then
          SQL = "DELETE FROM deuda WHERE id=" & Registro("id")
          BaseExecute SQL
          Registro.Close
          CargarRegistros
       End If
